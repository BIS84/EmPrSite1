...
if (age < 25) {
    ...
    document.getElementById("login1").innerHTML += `<div class="hi-h3"><h3>Привет, ${youName}!</h3></div>`;
} else if (age < 60) {
    // window.alert(`Здравствуйте, ${youName}!`);
    document.getElementById("login1").innerHTML += `<div class="hi-h3"><h3>Здравствуйте, ${youName}!</h3></div>`;
} else {
    // window.alert(`Спасибо, что посетили нас, уважаемый ${youName}!`);
    document.getElementById("login1").innerHTML += `<div class="hi-h3"><h3>Рады видеть Вас, уважаемый ${youName}!</h3></div>`;
}

document.getElementById("login1").innerHTML += `<div class="formLogin">
    <form>
